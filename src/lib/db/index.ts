...
export const db = withDatabaseInitLock(() => {
  ...
  for (const statement of [
    ...
    "ALTER TABLE accounts ADD COLUMN qq_auth_state TEXT NOT NULL DEFAULT 'active'",
    'ALTER TABLE accounts ADD COLUMN qq_auth_checked_at TEXT',
    'ALTER TABLE accounts ADD COLUMN qq_auth_error TEXT',
    'ALTER TABLE accounts ADD COLUMN emby_user_id TEXT',
    'ALTER TABLE accounts ADD COLUMN emby_access_token TEXT',
    'ALTER TABLE accounts ADD COLUMN emby_base_url TEXT',
    'ALTER TABLE accounts ADD COLUMN emby_api_key TEXT',
    'ALTER TABLE accounts ADD COLUMN emby_source_webdav_dsn TEXT',
    'ALTER TABLE accounts ADD COLUMN emby_proxy_timeout_ms INTEGER',
